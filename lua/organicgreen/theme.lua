...
theme.set_highlights = function()
  ...
  hl(0, "DiffText", { fg = c.sign_change, bg = c.bg })
  hl(0, "DiffAdd", { fg = c.fg_add, bg = c.bg })
  hl(0, "DiffChange", { fg = c.sign_change, bg = c.bg })
  hl(0, "DiffDelete", { fg = c.fg_delete, bg = c.bg })
  hl(0, "diffAdded", { fg = c.fg_add, bg = c.bg })
  hl(0, "diffRemoved", { fg = c.fg_delete, bg = c.bg })
  hl(0, "diffChanged", { fg = c.sign_change, bg = c.bg })
  hl(0, "diffOldFile", { fg = c.gray, bg = c.bg })
  hl(0, "diffNewFile", { fg = c.gray, bg = c.bg })
  hl(0, "diffFile", { fg = c.black, bg = c.bg })
  hl(0, "diffLine", { fg = c.purple, bg = c.bg })
  hl(0, "diffIndexLine", { fg = c.gray, bg = c.bg })
